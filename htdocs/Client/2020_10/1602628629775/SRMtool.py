...
def multi_ReadParaFunction(ParaFile):
    ...
    with open(ParaFile,'r') as f:
        ...
        while (i < len(data)) and (j < len(MethodNames)):
            ...
            k = 0
            while k < readLine:
                if(MethodNames[j] == 'predictionIntervals' or MethodNames[j] == 'vares' or MethodNames[j] == 'compares' or MethodNames[j] == 'ifUseEstimation' or MethodNames[j] == 'ifCompareNewData'):
